...
program
  ...
  .option('--auth-type <type>', 'Authentication type (bearer/basic/hmac-mexc/hmac-bybit/hmac-okx/headers/service-account/github-app/oauth1a-twitter). Use --header with headers type')
